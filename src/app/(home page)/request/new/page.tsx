          ...
          <section className="space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-orange-500 px-5 py-4 text-sm font-extrabold text-white transition hover:bg-orange-400 disabled:cursor-not-allowed disabled:opacity-60"
              >
                {isSubmitting ? (
                  <>
      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-8">
        <Link href="/" className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-xs text-zinc-400">ثبت درخواست اسکان</div>
          </div>
        </Link>
...
function SuccessBox({ trackingCode }: { trackingCode: string }) {
  return (
    <div className="mb-6 rounded-[28px] border border-emerald-400/20 bg-emerald-500/10 p-5">
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <div className="mt-4 inline-flex rounded-2xl border border-emerald-300/20 bg-zinc-950/40 px-4 py-3 text-lg font-black text-white">
            {trackingCode}
          </div>
          ...
          <div className="mt-4">
            <a
              href="/request/track"
              className="inline-flex rounded-xl bg-emerald-500 px-4 py-2 text-sm font-bold text-white transition hover:bg-emerald-400"
            >
...
function WarningBox({ children }: { children: React.ReactNode }) {
  return (
    <div className="mb-6 rounded-[28px] border border-red-400/20 bg-red-500/10 p-5 text-sm leading-7 text-red-100">
      <div className="flex items-start gap-3">
        ...
        <div>
          <div className="font-extrabold text-white">هشدار</div>
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div>
          <div className="flex flex-wrap items-center gap-2">
            <span className="inline-flex items-center gap-2 rounded-full border border-sky-300/20 bg-zinc-950/30 px-3 py-1 text-xs font-bold text-sky-200">
          ...
          <h2 className="mt-4 text-xl font-black text-white">{shelter.name}</h2>

          <div className="mt-3 flex flex-wrap items-center gap-x-5 gap-y-2 text-sm text-sky-100">
          ...
          {error && (
            <p className="mt-4 rounded-2xl border border-red-400/20 bg-red-500/10 px-4 py-3 text-sm leading-7 text-red-100">
              {error}
            </p>
          )}
        </div>
  ...
  return (
    <label className="block">
      ...
      <input
        ...
        inputMode={inputMode}
        className={`w-full rounded-2xl border bg-zinc-950/70 px-4 py-3 text-sm text-white outline-none transition placeholder:text-zinc-500 ${
          error
            ? "border-red-400/50 focus:border-red-400"
            : "border-white/10 focus:border-orange-400/40"
        }`}
      />

      {error && <p className="mt-2 text-xs leading-6 text-red-300">{error}</p>}
    </label>
  );
}
  ...
  return (
    <label className="block">
      ...
      <textarea
        ...
        onChange={(e) => onChange(e.target.value)}
        placeholder={placeholder}
        className={`w-full rounded-2xl border bg-zinc-950/70 px-4 py-3 text-sm leading-7 text-white outline-none transition placeholder:text-zinc-500 ${
          error
            ? "border-red-400/50 focus:border-red-400"
            : "border-white/10 focus:border-orange-400/40"
        }`}
      ...
      <div className="mt-2 flex items-center justify-between gap-3">
        {error ? (
          <p className="text-xs leading-6 text-red-300">{error}</p>
        ) : (
          <span />
        )}
  ...
  return (
    <label className="block">
      ...
      <select
        value={value}
        onChange={(e) => onChange(e.target.value)}
        className="w-full rounded-2xl border border-white/10 bg-zinc-950/70 px-4 py-3 text-sm text-white outline-none transition focus:border-orange-400/40"
      >
        {options.map((option) => (
          <option
            key={option.value}
...
function Checkbox({
  ...
  return (
    <label className="flex cursor-pointer items-center gap-3 rounded-2xl border border-white/10 bg-zinc-950/40 px-4 py-3 transition hover:bg-white/[0.04]">
      <input
        type="checkbox"
        checked={checked}
    ...
    >
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <div className="mt-2 text-sm leading-7 text-zinc-400">{subtitle}</div>
        </div>
...
function UploadBox({ label }: { label: string }) {
  return (
    <label className="block cursor-pointer rounded-[24px] border border-dashed border-white/15 bg-zinc-950/40 p-5 transition hover:bg-white/[0.03]">
  ...
  return (
    <div className="rounded-[28px] border border-white/10 bg-white/5 p-5">
      <div className="mb-4 flex items-center gap-3">
        ...
        <h3 className="font-extrabold text-white">راهنمای فرم</h3>
      </div>
  ...
  return (
    <div className="rounded-[28px] border border-white/10 bg-white/5 p-5">
      <div className="mb-4 flex items-center gap-3">
        ...
        <h3 className="font-extrabold text-white">مراحل بررسی</h3>
      </div>
